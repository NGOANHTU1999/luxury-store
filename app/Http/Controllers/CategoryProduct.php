...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product()
    {
        ...
        $manager_category_product = view('admin.Category.all_category_product')->with('all_category_product',
    ...
    public function edit_category_product($category_product_id)
    {
        ...
        $manager_category_product = view('admin.Category.edit_category_product')->with('edit_category_product',
    ...
    public function show_category_home(Request $request, $category_slug)
    {
        ...
        $category_by_id = DB::table('tbl_product')->join('tbl_category_product', 'tbl_product.category_id', '=',
            'tbl_category_product.category_id')->where('tbl_category_product.category_slug', $category_slug)->get();
        //hiện thị tên danh mục
        $category_name = DB::table('tbl_category_product')->where('tbl_category_product.category_slug',
            $category_slug)->limit(1)->get();
        ...
        return view('pages.category.show_category')->with('category', $cate_product)->with('brand',
            $brand_product)->with('category_by_id', $category_by_id)->with('category_name',
            $category_name)->with('meta_desc', $meta_desc)->with('meta_keywords', $meta_keywords)->with('meta_title',

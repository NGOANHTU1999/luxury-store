...
class PaymentController extends Controller
{
    ...
    public function return_payment(Request $request)
    {
        if ($request->vnp_ResponseCode == '00') {
            ...
            $title_mail = 'Orders confirmed purchase at Luxury - Store' . ' ' . $now;
            ...
            return view('pages.cart.cart_ajax')->with('message', 'Successful Payment')->with('meta_desc',
                $meta_desc)->with('meta_keywords', $meta_keywords)->with('meta_title',
            ...
            return view('pages.cart.cart_ajax')->with('message', 'Payment Failed')->with('meta_desc',
                $meta_desc)->with('meta_keywords', $meta_keywords)->with('meta_title',
                $meta_title)->with('url_canonical', $url_canonical);
        }

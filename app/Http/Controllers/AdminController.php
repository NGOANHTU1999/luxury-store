...
class AdminController extends Controller
{
    ...
    public function show_dashboard(Request $request)
    {
        ...
        return view('admin.dashboard')->with(compact('visiter_tuan_count', 'visiter_thang_count', 'visiter_count',
            'visiter_total_count', 'product_donut', 'post_donut', 'order_donut', 'customer_donut', 'category_donut',
            'brand_donut', 'post_view', 'product_view', 'post_new'));
    }
    ...
    public function dashboard(Request $request)
    {
        ...
        $result = DB::table('tbl_admin')->where('admin_name', $admin_name)->where('admin_password',
    ...
    public function dashboard_filter(Request $request)
    {
        ...
        if ($data['dashboard_value'] == '7ngayqua') {
            ...
            $get = Statistic::whereBetween('order_date', [$dau_thangtruoc, $cuoi_thangtruoc])->orderBy('order_date',
                'ASC')->get();

                        ...
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                ...
                                <ul class="product__item__pic__hover">
                                    ...
                                    ?>
                                    <li><a type="button" class="add-to-cart" data-id_product="{{$product->product_id}}"
                                           name="add-to-cart"><i class="fa fa-shopping-cart"></i></a></li>
                                    <?php
                                    }else{
                                    ?>
                                    <li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-shopping-cart"></i></a>
                                    </li>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="product__item__text">
                                ...
                                ?>
                                <h6>
                                    <a href="{{URL::to('chi-tiet-san-pham/'.$product->product_slug)}}">{{($product->product_name_en)}}</a>
                                </h6>
                                <?php
                                }else{
                                ?>

    ...
    <div class="table-responsive">
        <form action="{{URL::to('/payment-continue')}}" id="create_form" method="post">
            ...
            <div class="form-group">
                ...
                <input readonly class="form-control" id="order_id" name="order_id" type="text"
                       value="{{$checkout_code}}"/>
            </div>
            @php
                $total = 0;
                        ...
                        @foreach(Session::get('coupon') as $key =>$cou)
                            @if($cou['coupon_condition']==0)
                                ...
                                <input readonly class="form-control" id="amount" name="amount" type="number"
                                       value="{{$total_after_coupon +Session::get('fee')}}"/>
                            @else
                                @php
            ...
            <div class="form-group">
                ...
                <textarea style="resize: none;" class="form-control" cols="20" id="order_desc" name="order_desc"
                          rows="2">{{__('Thanh toán tiền mua sản phẩm')}}</textarea>
            </div>
            <div class="form-group">

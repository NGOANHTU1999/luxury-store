    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose card-header-text">
                <div class="card-text">
                    <h4 class="card-title">{{__('Update Brand Product')}}</h4>
                </div>
                ...
                <form action="{{URL::to('/update-brand-product',$edit_value->brand_id)}}" method="post"
                    ...
                    <div class="card-body ">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" type="text" onkeyup="ChangeToSlug();" id="slug"
                                           name="brand_product_name" value="{{$edit_value->brand_name}}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="brand_product_name_en"
                                           class="form-control" value="{{$edit_value->brand_name_en}}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <textarea style="resize: none;" name="brand_product_desc" class="form-control"
                                              rows="6">{{$edit_value->brand_desc}}</textarea>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        <div class="">
                            <center>
                                <button type="submit" class="btn btn-rose"
                                        name="update_brand_product">{{__('Update Brand')}}</button>
                            </center>
                        </div>
                </form>
        </div>

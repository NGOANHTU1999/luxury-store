...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
        <div class="navbar-wrapper">
            <a class="navbar-brand">Register Admin Page</a>
        </div>
...
<div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black"
         style="background-image: url({{asset('public/backend/assets/img/register.jpg')}}">
        <div class="container">
            <div class="row">
                    ...
                    <div class="card card-signup">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-5 ml-auto">
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            ...
                                            <p class="description">
                                                Use charts to statistics revenue, number of products, articles, ...
                                            </p>
                                        </div>
                                    </div>
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            <h4 class="info-title">Display</h4>
                                            <p class="description">
                                                Easy to use with many attractive functions...
                                            </p>
                                        </div>
                                    </div>
                                    <div class="info info-horizontal">
                                        ...
                                        <div class="description">
                                            <h4 class="info-title">Assign</h4>
                                            <p class="description">
                                                Assign permissions to users like admin, author, user...
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <span class="input-group-text">
                              <i class="material-icons">lock_outline</i>
                                                ...
                                                <input type="password" name="admin_password"
                                                       value="{{old('admin_password')}}" placeholder="Password..."
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group has-default">
                            ...
                            <span class="check"></span>
                                                ...
                                                Agree
                                                <a href="#something">with terms at LUXURY-STORE</a>.
                                            </label>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-round mt-4">Register
                                            </button>
                                        </div>
                                    </form>
                                </div>
    ...
    <script src="{{asset('public/backend/assets/js/material-dashboard.minf066.js?v=2.1.0')}}"

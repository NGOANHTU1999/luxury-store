        ...
        <div class="card">
           ...
           <?php
            ...
            @foreach($edit_post as $key => $edit)
                <form action="{{URL::to('/update-post/'.$edit->post_id)}}" method="post" class="form-horizontal"
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <input class="form-control" type="text" onkeyup="ChangeToSlug();" id="slug"
                                           name="post_title" value="{{$edit->post_title}}"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <span class="btn btn-rose btn-round btn-file">
                  ...
                  <input type="file" name="post_image" class="form-control"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <textarea style="resize: none;" name="post_desc" class="form-control"
                                              rows="6">{{$edit->post_desc}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <textarea style="resize: none;" id="ckeditor1" name="post_content"
                                              class="form-control" rows="6">{{$edit->post_content}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="">
                            <center>
                                <button type="submit" class="btn btn-rose"
                                        name="update_post">{{__('Update Post')}}</button>
                            </center>
                        </div>
                </form>
        </div>
